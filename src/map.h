...
class MapMenu : public QPopupMenu
{
 ...
 protected slots:
  ...
  void toggle_npc_corpses(int itemId);
  void toggle_pc_corpses(int itemId);
...
class Map :public QWidget
{
 ...
 public:
  ...
  bool showNpcCorpses() const { return m_showNpcCorpses; }
  bool showPcCorpses() const { return m_showPcCorpses; }
 ...
 public slots:   
  ...
  void setShowNpcCorpses(bool val);
  void setShowPcCorpses(bool val);
...
private:   
   ...
   bool m_showNpcCorpses;
   bool m_showPcCorpses;
